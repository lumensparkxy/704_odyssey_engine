...
"""
    ...
    async def _collect_report_preferences(self, session) -> Dict[str, Any]:
        ...
        self.console.print("\n" + "-" * 60)
        self.console.print(
            "[bold magenta]📝 Report Customization[/bold magenta]")
        self.console.print("-" * 60)
        ...
        existing_prefs = parsed_intent.get(
            "output_preferences", {}) if isinstance(parsed_intent, dict) else {}
        ...
        self.console.print(
            "  • [cyan]brief[/cyan] - 1-2 pages, executive summary focus")
        self.console.print(
            "  • [cyan]standard[/cyan] - 3-5 pages, balanced detail")
        self.console.print(
            "  • [cyan]comprehensive[/cyan] - 6+ pages, full analysis")
        ...
        self.console.print(
            "  • [cyan]general[/cyan] - Non-technical, accessible language")
        self.console.print(
            "  • [cyan]professional[/cyan] - Business/decision-maker focus")
        self.console.print(
            "  • [cyan]technical[/cyan] - Expert-level, detailed terminology")
        ...
        self.console.print(
            "  • [cyan]executive[/cyan] - Summary-focused, key insights first")
        self.console.print(
            "  • [cyan]academic[/cyan] - Detailed citations, thorough analysis")
        self.console.print(
            "  • [cyan]practical[/cyan] - Action-oriented, recommendations focus")
        ...
        include_visuals = Prompt.ask(
            "Include visuals",
            choices=["yes", "no"],
            default="yes" if existing_prefs.get(
                "include_visuals", True) else "no"
        )
        ...
        self.console.print(
            "  [dim]Enter comma-separated topics to emphasize, or press Enter to skip[/dim]")
        self.console.print(
            "  [dim]Examples: cost analysis, performance comparison, risk assessment[/dim]")
        ...
        self.console.print(
            f"  • Length: [cyan]{preferences['report_length']}[/cyan]")
        self.console.print(
            f"  • Audience: [cyan]{preferences['audience']}[/cyan]")
        self.console.print(
            f"  • Style: [cyan]{preferences['format_style']}[/cyan]")
        self.console.print(
            f"  • Visuals: [cyan]{'Yes' if preferences['include_visuals'] else 'No'}[/cyan]")
        if preferences.get("focus_areas"):
            self.console.print(
                f"  • Focus: [cyan]{', '.join(preferences['focus_areas'])}[/cyan]")
